...
var format_Bloques_0 = new ol.format.GeoJSON();
var features_Bloques_0 = format_Bloques_0.readFeatures(json_Bloques_0, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bloques_0 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bloques_0.addFeatures(features_Bloques_0);
var lyr_Bloques_0 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Bloques_0, 
                style: style_Bloques_0,
                popuplayertitle: "Bloques",
                interactive: true,
                title: '<img src="styles/legend/Bloques_0.png" /> Bloques'
            });
var format_mun_1 = new ol.format.GeoJSON();
var features_mun_1 = format_mun_1.readFeatures(json_mun_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_mun_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_mun_1.addFeatures(features_mun_1);
var lyr_mun_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_mun_1, 
                style: style_mun_1,
                popuplayertitle: "mun",
                interactive: true,
                title: '<img src="styles/legend/mun_1.png" /> mun'
            });
var format_rios_princ_2 = new ol.format.GeoJSON();
var features_rios_princ_2 = format_rios_princ_2.readFeatures(json_rios_princ_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_rios_princ_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_rios_princ_2.addFeatures(features_rios_princ_2);
var lyr_rios_princ_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_rios_princ_2, 
                style: style_rios_princ_2,
                popuplayertitle: "rios_princ",
                interactive: true,
                title: '<img src="styles/legend/rios_princ_2.png" /> rios_princ'
            });
